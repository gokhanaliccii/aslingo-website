...
const Hero = () => {
  return (
    <section id="home" className="px-10 pb-20 md:pb-0   text-gray-600 body-font bg-bgColor">
      <div className="container mx-auto flex px-5 py-16 sm:py-24 sm:pb-12 pb-0 md:flex-row flex-col items-center">
