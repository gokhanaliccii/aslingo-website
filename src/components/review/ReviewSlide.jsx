  ...
  return (
    <div className="group review-slide swiper-slide  bg-white border border-solid border-gray-300 flex justify-between flex-col rounded-xl p-6 transition-all duration-500  w-[80%] md:w-full mx-auto  hover:border-cora hover:shadow-sm ">
      <div className="">
        ...
        <p className="text-sm text-gray-600 leading-6  transition-all duration-500 pb-8 group-hover:text-gray-800 slide_active:text-gray-800">
          Thanks to pagedone, I feel more informed and confident about my
          investment decisions than ever before.
        </p>
      </div>
      <div className="flex justify-end items-center gap-3 pt-3 border-t border-solid border-gray-200">
        <img className="h-4 w-4" src={usFlag} alt="avatar" />
        <span className="text-sm">Bam Burn</span>
      </div>
    </div>
  );
};
